...
class Service
{
    ...
    protected function validateItem (Item $item)
    {
        ...
        if ($item->type() == Item::URL && strlen($item->key()) > 256) {
            return false;
    ...
    /**
     * Inflate the given array representation of an item, and return it as an instance of `Garbetjie\WeChatClient\Menu\Item`.
     *
     * @param array $item
     *
     * @return Item
